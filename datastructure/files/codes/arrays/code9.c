// Print union and intersection of given arrays:
#include <stdio.h>
...
int main()
{
    ...
    // Sortingsort(size1+size2,uni);
    // Remove repeated elementssize=removerepeated(size1+size2,uni);
    printf("Array afetr Union \n");
    for (i = 0; i < size; i++)
    {
        printf("%d\n", uni[i]);
    }
    // Intersection starts k=0;
    for (i = 0; i < size1; i++)
    {
        for (j = 0; j < size2; j++)
        {
    ...
    // Sortingsort(k,intersection);
    // Removing size=removerepeated(k,intersection);
